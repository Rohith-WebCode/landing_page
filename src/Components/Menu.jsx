...
const Menu = () => {
    ...
    useGSAP(()=>{
        ...
        gsap.fromTo('.details h2',{yPercent:100,opacity:0},{opacity:1,yPercent:0,ease:'power1.inOut'})
        gsap.fromTo('.details p',{yPercent:100,opacity:0},{opacity:1,yPercent:0,ease:'power1.inOut'})
    },[currentIndex])
